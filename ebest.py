...
class EBest:
    ...
    def get_account_stock_info(self):
        ...
        """
        in_params = {"RecCnt": "1", "AcntNo": self.account, "Pwd": self.passwd, "BalCreTp": "0", "CmsnAppTpCode": "0",
                     "D2balBaseQryTp": "0", "UprcTpCode": "0"}
        out_params = ["IsuNo", "IsuNm", "BnsBaseBalQty", "SellPrc", "BuyPrc", "NowPrc", "AvrUprc", "PnlRat",
                      "BalEvalAmt"]
    ...
    def order_stock(self, code, qty, price, bns_type, order_type="00"):
        ...
        out_params = ["OrdNo", "OrdTime", "OrdMktCode", "OrdPtnCode", "ShtnIsuNo", "MgempNo", "OrdAmt", "SpotOrdQty",
                      "IsuNm"]
